...
- ALU:
  ...
  2. ALU broadcasts the result to RoB and LSB, and tell them it's a MMIO.
...
- LSB:
  ...
  1. Initially, LSB regards it as a normal load.

  2. When ALU broadcasts is isn't, LSB updates it state and regard it as store except some extra info (dest).

- WB:

  1. WB gets instruction from LSB, and already knows it's mmio.
